...
#        fSFElec_Tracking     = ROOT.TFile('/afs/cern.ch/work/s/sesanche/public/SFs/forICHEP/electrons/egammaEffi.txt_SF2D.root')  
        ...
        self.triggerlist = [ 'HLT_MuEG', 
                             ...
                             'HLT_BIT_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled',
                             'HLT_BIT_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v_Prescale',
                             'HLT_BIT_HLT_DoubleEle25_CaloIdL_MW_v',
                             'HLT_BIT_HLT_DoubleEle25_CaloIdL_MW_v_isUnprescaled',
                             'HLT_BIT_HLT_DoubleEle25_CaloIdL_MW_v_Prescale',
                             'HLT_BIT_HLT_DoubleEle27_CaloIdL_MW_v',
                             'HLT_BIT_HLT_DoubleEle27_CaloIdL_MW_v_isUnprescaled',
                             'HLT_BIT_HLT_DoubleEle27_CaloIdL_MW_v_Prescale',
                             'HLT_BIT_HLT_DoubleEle33_CaloIdL_MW_v',
                             'HLT_BIT_HLT_DoubleEle33_CaloIdL_MW_v_isUnprescaled',
                             'HLT_BIT_HLT_DoubleEle33_CaloIdL_MW_v_Prescale',
                             'HLT_DoubleMu',
                             'HLT_DoubleMu_isUnprescaled',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v_isUnprescaled',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v_Prescale',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v_isUnprescaled',
                             'HLT_BIT_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v_Prescale',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8_v',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8_v_isUnprescaled',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8_v_Prescale',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_v',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_v_isUnprescaled',
                             'HLT_BIT_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_v_Prescale',
                             'HLT_BIT_HLT_Mu37_TkMu27_v',
                             'HLT_BIT_HLT_Mu37_TkMu27_v_isUnprescaled',
                             'HLT_BIT_HLT_Mu37_TkMu27_v_Prescale',
                             'HLT_HT',
    ...
    def listBranches(self):
        ...
        biglist = [ ("evt"+label, "D"),
                    ...
                    ("nTrueInt"+label, "F"),
                    #("nLHEweight"+label, "F"),
                    #("LHEweight_id"+label,"I", 200),
                    #("LHEweight_wgt"+label, "F", 200),
                    ...
                    ("metl1DPhi"+label, "F"),
                    ("metl2DPhi"+label, "F"),
                    ("met"+label, "F"), ("met_phi"+label, "F"), 
                    ("met_jecUp"+label, "F"), ("met_jecDn"+label, "F"),
                    ("met_shifted_MuonEnUp_pt"+label, "F"),("met_shifted_MuonEnDown_pt"+label, "F"),
                    ("met_shifted_ElectronEnUp_pt"+label, "F"),("met_shifted_ElectronEnDown_pt"+label, "F"),
                    ("met_shifted_UnclusteredEnUp_pt"+label, "F"),("met_shifted_UnclusteredEnDown_pt"+label, "F"),
                    ("genMet"+label, "F"), ("genMet_phi"+label,"F"),
                    ("isoTrack_pt"+label, "F"), ("isoTrack_phi"+label,"F"),("isoTrack_eta"+label, "F"),
                    ("lepsDPhi"+label, "F"),
                    ("Lep1_pt"+label, "F"), 
                    ("Lep1_eta"+label, "F"), 
                    ("Lep1_phi"+label, "F"),
...
#            jetsd_jecDn = [j for j in Collection(event,"DiscJet_jecDown","nDiscJet_jecDown")]
        ...
        ret['met_shifted_MuonEnUp_pt'] = event.met_shifted_MuonEnUp_pt; ret['met_shifted_MuonEnDown_pt'] = event.met_shifted_MuonEnDown_pt 
        ret['met_shifted_ElectronEnUp_pt'] = event.met_shifted_ElectronEnUp_pt; ret['met_shifted_ElectronEnDown_pt'] = event.met_shifted_ElectronEnDown_pt 
        ret['met_shifted_UnclusteredEnUp_pt'] = event.met_shifted_UnclusteredEnUp_pt; ret['met_shifted_UnclusteredEnDown_pt'] = event.met_shifted_UnclusteredEnDown_pt 
       # if self.isSMS:
       ...
       #     ret["ISRweight_Dn"     ] = event.ISRweight_Dn
        ...
        #not all MC has LHE weights stored
        #ret['LHEweight_wgt']      = ( [1.]*200 if not hasattr(event, 'LHEweight_wgt'     ) else getattr(event, 'LHEweight_wgt'))
        #ret['LHEweight_id']       = ( [1 ]*200 if not hasattr(event, 'LHEweight_id'      ) else getattr(event, 'LHEweight_id'))
        #ret['nLHEweight']         = ( 1.       if not hasattr(event, 'nLHEweight'        ) else getattr(event, 'nLHEweight'))
        ## twiki:
...
#            ret["nLepGood20T"] += 1
        ...
        if (len(leps) <4): 
            ...
            l1 = ROOT.TLorentzVector(); l2 = ROOT.TLorentzVector(); l3 = ROOT.TLorentzVector(); l4 = ROOT.TLorentzVector(); newMet=  ROOT.TLorentzVector();
                ...
                for j in lepVecs:
                    ...
                    if (abs((i+j).M() - 91.1876) < abs(bestmll - 91.1876)):
                        ...
                        for k in lepVecs:
                            ...
                            Z_ll_MT2 = computeMT2(lepVecsForMT2[lepVecs.index(i)], lepVecsForMT2[lepVecs.index(j)], metp4obj)
                            if i.Pt() > j.Pt():
                                WZ_ll_MT2 = computeMT2(lepVecsForMT2[lepVecs.index(i)], lepVecsForMT2[lepVecs.index(k)], metp4obj)
                            else:
                                WZ_ll_MT2 = computeMT2(lepVecsForMT2[lepVecs.index(j)], lepVecsForMT2[lepVecs.index(k)], metp4obj)
            ret['WmT'] = WmT
